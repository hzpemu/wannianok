...
allstr[0] =Lunarfix.getYearShengXiaoExact();
allstr[1] = a1.indexOf(allstr[0].substr(0,1))+1; //20190705 index+1
allstr[12] = Lunarfix.getYearGanExact()+Lunarfix.getYearZhiExact()//20230518->停用allstr[12] =cld[d].cYear;
allstr[13]=g1.indexOf(allstr[12].substr(0,1))+1; //20190705 index+1
allstr[14]=z1.indexOf(allstr[12].substr(1,1))+1; //20190705 index+1
allstr[15] = Lunarfix.getMonthGanExact()+Lunarfix.getMonthZhiExact();//20230518->停用allstr[15] = cld[d].cMonth;
...
allstr[21] =Lunarfix.getTimeGan()+Lunarfix.getTimeZhi();//20230518->停用allstr[21] =rtgan1+z11;
